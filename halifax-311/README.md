...
| `baseline_match.py` | Keyword-бейзлайн + харнесс замера точности |
...
| Выборка | top-1 | top-3 |
|---|---|---|
| `eval_utterances.jsonl` (те же фразы, что в keywords) | **87.2%** | 97.6% |
| `eval_holdout.jsonl` (другие формулировки) | **42.6%** | 52.9% |
