...
// OpenFreeMap supplies attribution through its tile source. Add custom credits
// only when configured, avoiding duplicate provider links on narrow screens.
export const MAP_ATTRIBUTION = process.env.NEXT_PUBLIC_MAP_ATTRIBUTION || undefined;
...
export const HALIFAX_PENINSULA = {
  center: [-63.583, 44.6488] as [number, number],
  zoom: 12.5,
  minZoom: 9,
  maxZoom: 18,
};
